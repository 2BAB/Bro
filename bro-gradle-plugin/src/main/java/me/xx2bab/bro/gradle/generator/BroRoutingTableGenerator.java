...
public class BroRoutingTableGenerator implements IBroGenerator<List<AnnotatedElement>> {
     ...
     */
    public void generateMergeMapFile(String packageName,
     ...
     */
    private void preCheckBeforeCollect(Map<String, BroProperties> map, String key, String errorType) throws DuplicatedNickException {

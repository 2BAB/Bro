...
class BroRoutingTableAnnoProcessor : IBroAnnoProcessor {
    ...
    private val comparator = Comparator<me.xx2bab.bro.common.gen.anno.Annotation> { a1, a2 -> a1.name.compareTo(a2.name) }
    ...
    override fun onCollect(element: Element, processingEnvironment: ProcessingEnvironment): String {
        ...
        annotatedElement.annotations = TreeSet(comparator)
